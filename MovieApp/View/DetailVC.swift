...
class DetailVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        movieName.text = "Name: Batman Begins"
        movieYear.text = "Year: 2005"
        movieImage.image = UIImage(named: "batman")
        movieActors.text = "Actors: Christian Bale, Michael Caine, Ken Watanabe"
        movieRating.text = "IMDB Rating: 8.2"
        movieLocation.text = "Location: United States, United Kingdom"
